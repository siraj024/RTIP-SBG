...
#ap.add_argument("--prototxt", required = True, default="MobileNetSSD_deploy.prototxt", help = "path to Caffe 'deploy' prototxt file")
ap.add_argument("--model", default="MobileNetSSD_deploy.caffemodel",
					help='Path to weights: '
						 'MobileNetSSD_deploy.caffemodel for Caffe model or ')

#ap.add_argument("--model:", required = True, default="MobileNetSSD_deploy.caffemodel", help = "path to Caffe pre-trained model")
